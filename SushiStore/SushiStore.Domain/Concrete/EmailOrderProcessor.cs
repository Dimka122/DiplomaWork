...
namespace SushiStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "sushistore@example.com";
        ...
        public string FileLocation = @"c:\sushiStore_store_emails";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Sushi.Price * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2:c}",
                        line.Quantity, line.Sushi.Name, subtotal);
                }
