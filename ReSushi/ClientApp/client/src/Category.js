...
export class Category extends Component {
    ...
    FilterFn() {
        ...
        var filteredData = this.state.categoryesWithoutFilter.filter(
            function (el) {
        ...
        this.setState({ categoryes: filteredData });
    }
    sortResult(prop, asc) {
        var sortedData = this.state.categoryesWithoutFilter.sort(function (a, b) {
            if (asc) {
        ...
        this.setState({ categoryes: sortedData });
    }
    ...
    refreshList() {
        fetch(variables.API_URL + 'Category/getCategory')
            .then(response => response.json())
            .then(data => {
                this.setState({ categoryes: data, categoryesWithoutFilter: data });
            });
    }
    ...
    createClick() {
        fetch(variables.API_URL + 'Category/addCategory', {
            method: 'POST',
            headers: {
    ...
    updateClick() {
        fetch(variables.API_URL + 'Category/updateCategory', {
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    deleteClick(id) {
        if (window.confirm('Are you sure?')) {
            fetch(variables.API_URL + 'Category/deleteCategory/' + id, {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
